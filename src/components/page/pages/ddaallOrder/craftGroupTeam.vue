<template>
    <div class="container">
        <div class="title">
            ...
            <router-link to="/orderList" style="color: #2a5389">工艺设计</router-link> ><span style="color: #345aff">组长</span>
        </div>
        <!-- <title-name></title-name> -->
        <el-card class="box-card">
            <div class="orderSearch tableTop" flex="main:justify" style="margin-top: 0">
                <div style="width: 300px; text-align: left">订单列表</div>

                <div flex class="osselect">
                    <el-select v-model="ssVal" @change="search">
                        <el-option v-for="item in selectStat" :key="item.id" :label="item.name" :value="item.id"> </el-option>
                    </el-select>
                    <el-select v-model="ssVal" @change="search">
