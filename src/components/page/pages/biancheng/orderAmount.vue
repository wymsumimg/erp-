<template>
    <div class="container">
        <div class="title">
            <router-link to="/bcOrderList" style="color: #2a5389">订单列表</router-link> >
            <router-link to="/checkOrde" style="color: #2a5389">查看</router-link> > <span style="color: #345aff">详情</span>
        </div>
            ...
            <tab :tableData="tableData" :label="label" style="margin-top: 21px">
                <template slot-scope="{ item, row }">
                    <span v-if="item.prop === 'operation'"
                        ><el-button @click="centerDialogVisible = true" type="text" size="small" class="lan">查看</el-button>
                        <el-button style="width: 52px" type="text" size="small"></el-button>
                        <el-button type="text" size="small" class="hong" @click="open">删除</el-button>
                    </span>
                </template>
            </tab>
            <page
