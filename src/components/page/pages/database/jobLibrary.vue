    ...
    <div class="container">
        ...
        <div class="orderCont">
                    ...
                    <div class="dialogclass typeBottom">
                        <el-form ref="form" :inline="true" :model="form" label-width="80px">
                            <el-form-item label="工件名称：">
                                <el-input v-model="formName" maxlength="20" ref="inputes" placeholder="请输入工件名称"></el-input>
                            </el-form-item>
                            <el-form-item>
                                <div flex="cross:center">
                                    <div>
                                        <el-tooltip v-if="!btn[47]" content="没有权限，不能操作" placement="top">
            ...
            <div class="tableTop" flex="cross:center ">
                <div style="width: 150px">工件列表</div>

                <div style="width: 100%" flex="cross:center main:justify">
                    <div></div>

                    <div class="detailSearch marr" flex="cross:center ">
                        <el-input v-model="compPama.QueryString" clearable placeholder="请输入工件名称"></el-input>
            ...
            <!-- <div flex="cross:center main:justify">
                <el-button class="butn" style="height: 40px" @click="addleixing">添加工件</el-button>
            ...
            <div class="orderTable">
                <div class="tableod">
                    ...
                    >
                        ...
                        <el-table-column prop="name" label="工件名称" align="center"> </el-table-column>
                        <el-table-column prop="address" label="操作" align="center">
                            <slot slot-scope="scope">
                                <div class="mojuCaozuo" flex="cross:center main:center">
                                    ...
                                    <div>
                                        <el-tooltip v-if="!btn[48]" content="没有权限，不能操作" placement="top">
            ...
            <el-dialog :title="dioName" :visible.sync="addLx" width="500px">
                <div>
                    <el-form ref="form" :model="form" label-width="120px">
                        <el-form-item label="工件名称：">
                            <el-input v-model="formName" placeholder="请输入工件名称"></el-input>
                        </el-form-item>
                    </el-form>
                </div>
...
<script>
import { BomTypeList, AddBomType, ModifyBomType, DeleteBomType } from '@/api/base';
export default {
    components: {},
    data() {
        return {
    ...
    methods: {
            ...
            this.$confirm('确定要删除此项吗？', '提示', {
                ...
                .then(() => {
                    ...
                    DeleteBomType(params).then((res) => {
                        ...
                        if (ReturnCode == 203) {
                            this.$message.error('删除失败，此工件已被设计管理创建');
                        }
                    });
                })
                .catch(() => {});
        ...
        getBomTypeList() {
            BomTypeList(this.compPama).then((res) => {
