<template>
    <div class="container">
        <div class="orderTop">
            数据库<span class="dayu">></span><span style="cursor: pointer" @click="jump()" class="nextchuang">原材料库</span
            ...
            <div class="orderTable">
                <div class="tableod">
                    ...
                    >
                        ...
                        <el-table-column prop="name" label="原材料类型" align="center"> </el-table-column>
...
<script>
import { MateialTypeList, AddMateialType, ModifyMateialType, DeleteMateialType } from '@/api/base';
export default {
    components: {},
    data() {
        return {
    ...
    methods: {
        ...
        delClick(row) {
            this.$confirm('确定要删除此项吗？', '提示', {
                ...
                .then(() => {
                    ...
                    DeleteMateialType(params).then((res) => {
                        ...
                        if (ReturnCode == 203) {
                            this.$message.error('删除失败，此原材料类型已被创建原材料');
                        }
                    });
                })
                .catch(() => {});
        ...
        getMateialTypeList() {
            MateialTypeList(this.compPama).then((res) => {
        ...
        saveDio() {
            ...
            if (this.saveSure == 0) {
                ...
                ModifyMateialType(params).then((res) => {
                    let { ReturnCode, Data } = res;
                    if (ReturnCode == 200) {
