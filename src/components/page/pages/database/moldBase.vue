    ...
    <div class="container">
        ...
        <div class="orderCont">
                    ...
                    <div class="dialogclass typeBottom">
                        <el-form ref="form" :inline="true" :model="form" label-width="80px">
                            <el-form-item label="类型名称：">
                                <el-input ref="inputes" v-model="formName" maxlength="20" placeholder="请输入模具类型名称"></el-input>
                            </el-form-item>
                            <el-form-item label="">
                                <div flex="cross:center">
                                    <div>
                                        <el-tooltip v-if="!btn[32]" content="没有权限，不能操作" placement="top">
            ...
            <div class="tableTop" flex="cross:center ">
                <div style="width: 150px">模具类型列表</div>

                <div style="width: 100%" flex="cross:center main:justify">
                    <div></div>

                    <div class="orderSearches" flex="cross:center ">
                        <el-input v-model="compPama.QueryString" clearable placeholder="请输入模具类型"></el-input>
            ...
            <div class="orderTable">
                <div class="tableod">
                    ...
                    >
                        ...
                        <el-table-column prop="name" label="模具类型" align="center"> </el-table-column>
                        <el-table-column prop="address" label="操作" align="center">
                            <slot slot-scope="scope">
                                <div class="mojuCaozuo" flex="cross:center main:center">
                                    ...
                                    <div>
                                        <el-tooltip v-if="!btn[33]" content="没有权限，不能操作" placement="top">
...
<script>
import { MoldTypeList, AddMoldType, ModifyMoldType, DeleteMoldType } from '@/api/base';
export default {
    components: {},
    data() {
        return {
    ...
    methods: {
            ...
            this.$confirm('确定要删除此项吗？', '提示', {
                ...
                .then(() => {
                    ...
                    DeleteMoldType(params).then((res) => {
                        ...
                        if (ReturnCode == 203) {
                            this.$message.error('删除失败，此模具类型已被订单管理创建订单!');
                            this.getMoldTypeList();
                        }
                    });
                })
        ...
        getMoldTypeList() {
            MoldTypeList(this.compPama).then((res) => {
